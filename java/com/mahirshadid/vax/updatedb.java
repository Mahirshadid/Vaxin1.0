...
import com.mahirshadid.vax.reg.adapter;
...
public class updatedb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(updatedb.this,"Loading...",Toast.LENGTH_LONG).show();
        ...
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(!snapshot.exists()){
                    ...
                    fline.setLayoutManager(new LinearLayoutManager(updatedb.this));
                    adapter1=new adapter(list3,updatedb.this,"Front-line Worker");
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(updatedb.this,error.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(!snapshot.exists()){
                    ...
                    doctor.setLayoutManager(new LinearLayoutManager(updatedb.this));
                    adapter1=new adapter(list4,updatedb.this,"Doctor");
        ...
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(!snapshot.exists()){
                    ...
                    pm.setLayoutManager(new LinearLayoutManager(updatedb.this));
                    adapter1=new adapter(list1,updatedb.this,"Parliament Member");
        ...
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(!snapshot.exists()){
                    ...
                    teacher.setLayoutManager(new LinearLayoutManager(updatedb.this));
                    adapter1=new adapter(list5,updatedb.this,"Teacher");
        ...
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(!snapshot.exists()){
                    ...
                    student.setLayoutManager(new LinearLayoutManager(updatedb.this));
                    adapter1=new adapter(list2,updatedb.this,"Student");
        ...
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(!snapshot.exists()){
                    ...
                    nid.setLayoutManager(new LinearLayoutManager(updatedb.this));
                    adapter1=new adapter(list6,updatedb.this,"18+ NID-Birth-certificate Holder");
